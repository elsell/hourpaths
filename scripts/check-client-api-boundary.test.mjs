...
result = check({
  'apps/mobile/src/ui/comment-edit-sheet.tsx': "import { AccessibilityInfo, Alert, StyleSheet, View } from 'react-native'; export const Edit = () => <View />; void AccessibilityInfo; void Alert; void StyleSheet;",
  'apps/mobile/src/ui/practice-comments-view.tsx': "import { ActivityIndicator, Alert, FlatList, KeyboardAvoidingView, Platform, Pressable, StyleSheet, View, useWindowDimensions } from 'react-native'; export const Comments = () => <KeyboardAvoidingView><FlatList data={[]} renderItem={() => <Pressable><View><ActivityIndicator /></View></Pressable>} /></KeyboardAvoidingView>; void Alert; void Platform; void StyleSheet; void useWindowDimensions;",
