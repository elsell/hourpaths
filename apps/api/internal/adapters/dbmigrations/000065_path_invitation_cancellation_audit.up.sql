...
ALTER TABLE public.audit_event_models ADD CONSTRAINT audit_event_models_action_check CHECK (action IN (
  ...
  'path_invitation.accepted','path_invitation.rejected','path_invitation.canceled','path_ownership_transfer.created',
  'path_ownership_transfer.listed','path_ownership_transfer.accepted','path_ownership_transfer.declined','path_ownership_transfer.canceled'
));
COMMIT;
